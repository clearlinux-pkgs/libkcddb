...
Version  : 21.12.0
Release  : 33
URL      : https://download.kde.org/stable/release-service/21.12.0/src/libkcddb-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/libkcddb-21.12.0.tar.xz
...
%prep
%setup -q -n libkcddb-21.12.0
cd %{_builddir}/libkcddb-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639611702
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkcddb-21.12.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libkcddb/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libkcddb-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/libkcddb/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/libkcddb-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/libkcddb/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/libkcddb-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkcddb/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/libkcddb-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkcddb/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
%find_lang kcmcddb
