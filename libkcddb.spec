...
Version  : 24.02.1
Release  : 63
URL      : https://download.kde.org/stable/release-service/24.02.1/src/libkcddb-24.02.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/libkcddb-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/libkcddb-24.02.1.tar.xz.sig
...
%prep
%setup -q -n libkcddb-24.02.1
cd %{_builddir}/libkcddb-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711037957
mkdir -p clr-build
pushd clr-build
