...
Version  : 19.12.2
Release  : 16
URL      : https://download.kde.org/stable/release-service/19.12.2/src/libkcddb-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/libkcddb-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/libkcddb-19.12.2.tar.xz.sig
...
%prep
%setup -q -n libkcddb-19.12.2
cd %{_builddir}/libkcddb-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581033213
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkcddb-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/libkcddb/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/libkcddb-19.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/libkcddb/fcbf818f92ef8679a88f3778b12b4c8b5810545b
cp %{_builddir}/libkcddb-19.12.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkcddb/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/libkcddb-19.12.2/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkcddb/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang kcmcddb
