...
Version  : 23.08.1
Release  : 56
URL      : https://download.kde.org/stable/release-service/23.08.1/src/libkcddb-23.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/libkcddb-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/libkcddb-23.08.1.tar.xz.sig
...
%prep
%setup -q -n libkcddb-23.08.1
cd %{_builddir}/libkcddb-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695060950
mkdir -p clr-build
pushd clr-build
