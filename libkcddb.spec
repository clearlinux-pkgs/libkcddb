...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/libkcddb-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/libkcddb-19.12.1.tar.xz.sig
...
%prep
%setup -q -n libkcddb-19.12.1
cd %{_builddir}/libkcddb-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578683303
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkcddb-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/libkcddb/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/libkcddb-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/libkcddb/fcbf818f92ef8679a88f3778b12b4c8b5810545b
cp %{_builddir}/libkcddb-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkcddb/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/libkcddb-19.12.1/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkcddb/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang kcmcddb
